...
<a href="?view={target_view}" target="_self" style="text-decoration: none; display: block; margin-bottom: 1rem;">
    <div class="custom-logo-container">
        <div style="display: flex; align-items: center; justify-content: center;">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 120" width="100%" height="45">
                <defs>
                ...
                <g transform="translate(10, 4) scale(1.05)">
                ...
                <text x="120" y="70" font-family="system-ui, -apple-system, sans-serif" font-size="28" font-weight="800" fill="#f8fafc">Logi<tspan fill="#3b82f6">Audit</tspan> <tspan font-size="16" font-weight="500" fill="#94a3b8">SaaS ENGINE</tspan></text>
            </svg>
        </div>
    </div>
</a>
